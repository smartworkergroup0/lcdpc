...
@Component({
  ...
  template: `
    <p-dialog [header]="isEditMode ? 'Editar Marca' : 'Nueva Marca'"
      ...
      <ng-template pTemplate="footer">
        ...
        <p-button [label]="isEditMode ? 'Guardar Cambios' : 'Crear Marca'"
...
export class BrandFormDialogComponent implements OnChanges {
  ...
  protected form: CreateBrandRequest = this.emptyForm();
  ...
  save(): void {
    ...
    const operation = this.isEditMode
      ...
      : this.brandApi.create(this.form);
